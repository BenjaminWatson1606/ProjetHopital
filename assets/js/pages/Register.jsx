...
export default function Register() {
  ...
  return (
    <body className="g-sidenav-show  bg-gray-100 montserrat body1">
...
>>>>>>> e9fd40d6c5b688eb7b82f8e60ee93cdc975d24eb
              <div className="col-3 me-auto px-1">
                ...
                <div className="card-body montserrat">
                  <form role="form text-left" onSubmit={handleSubmit}>
                    ...
                    <p className="text-sm mt-3 mb-0 montserrat">{t("haveAccount")} <a href="javascript:;" className="text-dark font-weight-bolder">{t("logIn")}</a></p>
                  </form>
                </div>
              </div>
            </div>
